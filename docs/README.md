...
- [Downturn Overlay Methodology](methodology_downturn_overlays.md)
- [Limitations And Assumptions](limitations_and_assumptions.md)
...
Current staged local source dates are:

- `ABS Building Approvals (Non-residential)`: through `February 2026`
- `RBA F1`: snapshot published `2 April 2026`, latest staged observation dated `16 March 2026`
- legacy industry inputs: annual ABS data through FY `2023-24`, quarterly ABS Business Indicators through `December 2025`, monthly labour-force data through `February 2026`, and PTRS Cycle `8` / Cycle `9`
