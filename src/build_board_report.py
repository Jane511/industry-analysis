...
from src.reporting.industry_analysis_report import MANIFEST_PATH, build_report, load_public_manifest
...
def main() -> None:
    ...
    if MANIFEST_PATH.exists():
        ...
        print(f"Warning: public-data manifest not found at {MANIFEST_PATH}; continuing without it.", file=sys.stderr)
        manifest = {}
