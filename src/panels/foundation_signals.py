...
STRUCTURAL_SCORE_ANCHORS = {
    "agriculture forestry and fishing": {"rate_sensitivity": 3, "demand_dependency": 4, "external_shock": 4},
    "manufacturing": {"rate_sensitivity": 3, "demand_dependency": 4, "external_shock": 4},
    "construction": {"rate_sensitivity": 4, "demand_dependency": 5, "external_shock": 4},
    "wholesale trade": {"rate_sensitivity": 3, "demand_dependency": 3, "external_shock": 3},
    "retail trade": {"rate_sensitivity": 4, "demand_dependency": 4, "external_shock": 4},
    "accommodation and food services": {"rate_sensitivity": 4, "demand_dependency": 5, "external_shock": 4},
    "transport postal and warehousing": {"rate_sensitivity": 3, "demand_dependency": 3, "external_shock": 3},
    "professional scientific and technical services": {"rate_sensitivity": 2, "demand_dependency": 2, "external_shock": 2},
    "health care and social assistance": {"rate_sensitivity": 2, "demand_dependency": 1, "external_shock": 2},
    "health care and social assistance private": {"rate_sensitivity": 2, "demand_dependency": 1, "external_shock": 2},
}
...
def build_foundation(public_dir: Path, processed_dir: Path) -> pd.DataFrame:
    ...
    df["foundation_source"] = "generated from ABS Australian Industry public data using deterministic APRA-informed proxy classification rules"
