...
REFERENCE_OUTPUT_DIR = REPO_ROOT / "data" / "output"
REFERENCE_OUTPUT_REGION_RISK_DIR = REFERENCE_OUTPUT_DIR / "region_risk"
REFERENCE_OUTPUT_PROPERTY_CYCLE_DIR = REFERENCE_OUTPUT_DIR / "property_cycle"
REFERENCE_OUTPUT_ARREARS_ENV_DIR = REFERENCE_OUTPUT_DIR / "arrears_environment"
REFERENCE_OUTPUT_DOWNTURN_DIR = REFERENCE_OUTPUT_DIR / "downturn_overlays"
