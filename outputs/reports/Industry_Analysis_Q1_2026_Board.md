...
*Board Summary variant. Generated 2026-06-11.*
...
| industry_failure_rates.csv | Realised insolvency counts (ASIC Series 1A) divided by ABS active-business counts per ANZSIC division, plus YoY change in the rate. | PD backtest and validation; ECL current-state anchoring; Governance concentration reporting; External sector benchmarks |
